...
the Couchbase Ruby gem with Rails ActiveModel.



== Getting Started

To learn how to create a project like this, and learn data modeling techniques, please visit http://CouchbaseOnRails.com
